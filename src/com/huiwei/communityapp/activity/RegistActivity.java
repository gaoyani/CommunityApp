...
import com.huiwei.communityapp.task.GetAuthCodeTask;
import com.huiwei.communityapp.task.RegistTask;
...
import com.huiwei.communityapp.view.EditInputView;
		...
		case R.id.button_regist: {
			if (checkInput()) {
				RegistTask task  = new RegistTask(RegistActivity.this, registHandler, username.getText(), 
						...
						address.getText(), authCode.getText());
				task.execute();
